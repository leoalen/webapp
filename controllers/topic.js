	...
	save: function(req, res){
		...
		getTopics: function(req, res){
			...
			Topic.paginate({}, options, (err, topics) => {
				...
				//Devolver resutados [topics, total de topics, total de paginas]
				return res.status(200).send({
					status: 'success',
					topics: topics.docs,
		...
		update: function(req, res){
			...
			//Rocoger el id del topic de la url
			var topicId = req.params.id;
			...
			if(validate_title && validate_content && validate_lang){
					...
					Topic.findOneAndUpdate({_id: topicId, user: req.user.id}, update, {new:true}, (err, topicUpdate) => {
		...
		delete: function(req, res){
			//Sacar  el id  del topic de la urñ
			var topicId = req.params.id;
